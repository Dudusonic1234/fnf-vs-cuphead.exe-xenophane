...
function onCreate()
	...
	makeAnimatedLuaSprite('groin', 'groin', 0, 0)
    addAnimationByPrefix('groin', 'groin', 'Cupheadshit_gif instance 1', 24, true)
    setObjectCamera('groin', 'other')
    addLuaSprite('groin', true)
end
